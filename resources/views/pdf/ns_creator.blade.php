...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <h3>nicht selbständiger Creator</h3>
        ...
        <h3>Private Angaben</h3>
        <table class="table table-borderless">
            <tr>
                <td class="pr-3">AHV-Nr.</td>
                <td>756.{{ $pdfData["ahv_nr"] }}</td>
            </tr>
            <tr>
                <td class="pr-3">Kinder</td>
                <td>{{ $pdfData["children"] }}</td>
            </tr>
            <tr>
                <td class="pr-3">Nationalität</td>
                <td>{{ $pdfData["nationality"] }}</td>
            </tr>
        </table>
        <br />
        <br />
