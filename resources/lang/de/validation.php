...
return [
    'profile_picture_validation'             => 'Bitte wählen Sie ein Bild (jpg oder png) aus.',
    'sva_validation'             => 'Bitte wählen Sie eine PDF Datei aus',
    ...
    'attributes'           => [
        ...
        'complexities_fk'       => 'Komplexität',
        'payment_types_fk'      => 'Zahlungsmöglichkeit',
        'categories_fk'         => 'Kategorie',
        'subcategories_fk'      => 'Unterkategorie',
        'cost'                  => 'Kosten',
        'website'               => 'Webseite',
        'street'                => 'Strasse & Nr.',
        'second'                => 'Sekunde',
        ...
        'year'                  => 'Jahr',
        'plz'                  => 'Postleitzahl',
        'organisation telephone'                  => 'Telefonnummer der Firma',
        'organisation plz'                  => 'Postleitzahl der Firma',
        'organisation uid'                  => 'UID-Nummer der Firma',
        'organisation name'                  => 'Name der Firma',
        'organisation type'                  => 'Typ der Organisation',
        'ahv_nr'                  => 'AHV-Nummer',
        'nationality'                  => 'Nationalität',
        'children'                  => 'Kinder',
        'apply text'                  => 'Bewerbungstext',
    ],
];
